package tema9programacionorientadaaobjetos.fraccionconmenu;
...
public class Fraccion implements Comparable<Fraccion> {
   ...
   * @param y
   *          denominador de la fracción, debe ser mayor que cero.
   */
   ...
   * 
   * @param den
   *          denominador de la fracción. Debe ser mayor o igual que cero.
  ...
  /**
   * Multiplica la fracción actual por la recibida como parámetro y actualiza
  ...
  /**
   * Multiplica la fracción actual por el entero recibido como parámetro y
   * actualiza numerador y denominador.
   * 
   * @param a
   *          entero a multiplicar.
   */
  ...
  /**
   * Divide el objeto Fracción actual por la fracción recibida como parámetro y
   * actualiza numerador y denominador.
   * 
   * @param a
   */
  ...
  /**
   * Divide el objeto Fracción actual por el entero recibido como parámetro y
   * actualiza numerador y denominador.
   * 
   * @param a
   */
