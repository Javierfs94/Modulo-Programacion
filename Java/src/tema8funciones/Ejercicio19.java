...
public class Ejercicio19 {
	...
	public static long binarioAOctal(long binario) {
		...
		octal = Matematicas.pegaPorDetras((int) octal, 1);
		octal = Matematicas.voltea((int) octal);
		octal = Matematicas.quitaPorDetras((int) octal, 1);
		octal = Matematicas.quitaPorDelante((int) octal, 1);
	...
	public static long octalABinario(long octal) {
		...
		for (int i = 0; i < Matematicas.digitos(octal); i++) {
			binario = binario * 1000 + decimalABinario(Matematicas.digitoN((int) octal, i));
		}
	...
	public static long decimalABinario(long decimal) {
		...
		while (decimal > 1) {
			binario = Matematicas.pegaPorDetras((int) binario, (int) decimal % 2);
			decimal = decimal / 2;
		}
		binario = Matematicas.pegaPorDetras((int) binario, 1);
		binario = Matematicas.voltea((int) binario);
		binario = Matematicas.quitaPorDetras((int) binario, 1);
